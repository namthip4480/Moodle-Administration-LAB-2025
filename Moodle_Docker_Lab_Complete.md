...
**บันทึกผลการทดลอง 1:**
<img width="1329" height="395" alt="image" src="https://github.com/user-attachments/assets/fcbcfcb4-32de-4787-842f-76174d093d24" />
```bash
  รูปผลการโหลด Image ที่สมบูรณ์
...
**บันทึกผลการทดลอง 2:**
<img width="1131" height="170" alt="image" src="https://github.com/user-attachments/assets/ed48fb40-2590-48d7-8afb-71a97af730a0" />
```bash
...
**บันทึกผลการทดลอง 3:**
 <img width="2118" height="270" alt="image" src="https://github.com/user-attachments/assets/9b4f64cf-cc17-4625-bb00-4bce2cba7a2f" />
```bash
...
```
**บันทึกผลการทดลอง 4:**
<img width="2254" height="1503" alt="image" src="https://github.com/user-attachments/assets/55c570af-092f-44a1-8994-87454bfd9dc8" />

<img width="2255" height="1503" alt="image" src="https://github.com/user-attachments/assets/4d9fe54f-d056-43fb-b0a6-3cced4a58dfb" />

<img width="2255" height="1503" alt="image" src="https://github.com/user-attachments/assets/26aef4f9-6c08-4919-997b-9df86102a443" />

<img width="2255" height="1503" alt="image" src="https://github.com/user-attachments/assets/20a14915-e0ce-480a-a1d0-39deff264d2c" />
...
5. 
   **บันทึกผลการทดลอง 11:**
   <img width="2255" height="1503" alt="image" src="https://github.com/user-attachments/assets/5c36cb8c-93e4-4628-bafc-78c41091c2dc" />
...
คำตอบ:
```
Docker Image คือไฟล์ต้นแบบที่แก้ไขไม่ได้ (Read-only) เปรียบเสมือนแผ่นติดตั้งโปรแกรม เช่น Image ของ Moodle 4.1.2 ส่วน Docker Container คือตัวโปรแกรมที่รันขึ้นมาจาก Image นั้นและใช้งานได้จริง เปรียบเสมือนเครื่องคอมพิวเตอร์ที่ติดตั้งโปรแกรมพร้อมใช้งานแล้ว
```
...
คำตอบ:
```
มี 2 ตัว คือ 1. Moodle App ทำหน้าที่เป็น Web Server ประมวลผลภาษา PHP และแสดงผลหน้าเว็บ 2. Database (เช่น MariaDB) ทำหน้าที่จัดเก็บข้อมูลรายชื่อผู้ใช้งาน รายวิชา และคะแนนทั้งหมด
```
...
```
วิธีตรวจสอบ:
ใช้คำสั่ง docker-compose logs เพื่อดูข้อความ Error หรือใช้ docker ps เช็กว่า Container DB ยังรันอยู่หรือไม่

วิธีแก้ไข:
ตรวจสอบชื่อ Host, Username และ Password ในไฟล์ docker-compose.yml ให้ตรงกันทั้งฝั่ง Moodle และ Database
```
